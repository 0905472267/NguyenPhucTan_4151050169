...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container">
        <asp:SqlDataSource ID="sqlSanPham" runat="server" ConnectionString="<%$ ConnectionStrings:SHOPNUOCHOAConnectionString2 %>" SelectCommand="SELECT * FROM [SanPham] WHERE ([MaSanPham] = @MaSanPham)">
            <SelectParameters>
                    ...
                    <tr>
                        ...
                        <td class="product-detail pl-3">
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <asp:Button ID="Button1" runat="server" CssClass="btn btn-danger btn-sm mt-2 d-block" PostBackUrl='<%# Eval("MaSanPham", "GioHang.aspx?MaSanPham={0}") %>' Text="Đặt mua" />
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                </tr>
