...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style=" width:100%; height: 100%">
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:SHOPNUOCHOAConnectionString2 %>" SelectCommand="SELECT * FROM [DonHang] WHERE ([MaDonHang] = @MaDonHang)">
            <SelectParameters>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:SHOPNUOCHOAConnectionString2 %>" SelectCommand=" SELECT  TenSanPham, Gia,SoLuong  , Gia*SoLuong as 'ThanhTien',Anh 
...
">
        ...
        <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:SHOPNUOCHOAConnectionString2 %>" SelectCommand="  SELECT  Sum( Gia*SoLuong) as 'ThanhTien'
 FROM  DonHang inner join ChiTietDonHang 
 on DonHang.MaDonHang=ChiTietDonHang.MaDonHang 
 inner join SanPham on ChiTietDonHang.MaSanPham=SanPham.MaSanPham  
 where DonHang.MaDonHang=@MaDonHang ">
