...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div  class="container"> 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SHOPNUOCHOAConnectionString2 %>" SelectCommand="SELECT TOP (1000) MaSanPham, MaThuongHieu, MaDanhMuc, TenSanPham, Gia, NongDo, XuatSu, NamPhatHanh, NhomHuong, PhongCach, DungTich, MoTa, Anh FROM SanPham WHERE (Gia &gt; @gia) AND (Gia &lt;= @gia + 500000)">
            <SelectParameters>
