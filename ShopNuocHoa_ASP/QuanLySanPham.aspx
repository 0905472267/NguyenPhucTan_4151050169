...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="Sqlddlsp" runat="server" ConnectionString="<%$ ConnectionStrings:SHOPNUOCHOAConnectionString2 %>" SelectCommand="SELECT [MaSanPham], [TenSanPham] FROM [SanPham]" ProviderName="<%$ ConnectionStrings:SHOPNUOCHOAConnectionString2.ProviderName %>"></asp:SqlDataSource>
    <br />
    <asp:SqlDataSource ID="sqlsanpham" runat="server" ConnectionString="<%$ ConnectionStrings:SHOPNUOCHOAConnectionString2 %>" DeleteCommand="DELETE FROM [SanPham] WHERE [MaSanPham] = @MaSanPham" InsertCommand="INSERT INTO [SanPham] ([MaThuongHieu], [MaDanhMuc], [TenSanPham], [Gia], [NongDo], [XuatSu], [NamPhatHanh], [NhomHuong], [PhongCach], [DungTich], [MoTa], [Anh]) VALUES (@MaThuongHieu, @MaDanhMuc, @TenSanPham, @Gia, @NongDo, @XuatSu, @NamPhatHanh, @NhomHuong, @PhongCach, @DungTich, @MoTa, @Anh)" SelectCommand="SELECT * FROM [SanPham] WHERE ([MaSanPham] = @MaSanPham)" UpdateCommand="UPDATE [SanPham] SET [MaThuongHieu] = @MaThuongHieu, [MaDanhMuc] = @MaDanhMuc, [TenSanPham] = @TenSanPham, [Gia] = @Gia, [NongDo] = @NongDo, [XuatSu] = @XuatSu, [NamPhatHanh] = @NamPhatHanh, [NhomHuong] = @NhomHuong, [PhongCach] = @PhongCach, [DungTich] = @DungTich, [MoTa] = @MoTa, [Anh] = @Anh WHERE [MaSanPham] = @MaSanPham" ProviderName="<%$ ConnectionStrings:SHOPNUOCHOAConnectionString2.ProviderName %>">
        <DeleteParameters>
            ...
            <table style="width: 113%">
                ...
                <tr>
                    ...
                    <td class="text-left" style="height: 24px; width: 351px;">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:SHOPNUOCHOAConnectionString2 %>" SelectCommand="SELECT * FROM [ThuongHieu]"></asp:SqlDataSource>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td class="text-left" style="width: 351px">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SHOPNUOCHOAConnectionString2 %>" SelectCommand="SELECT [MaDanhMuc] FROM [DanhMuc]" ProviderName="<%$ ConnectionStrings:SHOPNUOCHOAConnectionString2.ProviderName %>"></asp:SqlDataSource>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td class="text-left">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:SHOPNUOCHOAConnectionString2 %>" ProviderName="<%$ ConnectionStrings:SHOPNUOCHOAConnectionString2.ProviderName %>" SelectCommand="SELECT * FROM [ThuongHieu]"></asp:SqlDataSource>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
