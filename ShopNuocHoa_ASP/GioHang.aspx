...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:sqldatasource runat="server" ID="sqlDSP" ConnectionString="<%$ ConnectionStrings:SHOPNUOCHOAConnectionString2 %>" SelectCommand="SELECT [MaSanPham], [TenSanPham], [NongDo], [XuatSu], [NamPhatHanh], [NhomHuong], [PhongCach], [DungTich], [MoTa], [Gia], [Anh] FROM [SanPham] WHERE ([MaSanPham] = @MaSanPham)">
        <SelectParameters>
